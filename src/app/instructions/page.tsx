...
const thingsToInclude = [
  "Your detailed introduction, including your name, background, and interests",
  "Your academic qualifications, such as degrees, certifications, and any notable achievements",
